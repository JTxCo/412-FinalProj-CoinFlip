...
public class GameViewController {
    ...
    public void leadersBoard() {
        try {
            ...
            // if (retval.contains(",")) {
            System.out.println("client> received from server for leaderboard: " + retval);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (gameView.getHeadsButton().isSelected()) {
                ...
                try {
                    ...
                    String retval = socketReader.readLine();
                    System.out.println("client> recieved from server in heads: " + retval);
                ...
                try {
                    ...
                    String retval = socketReader.readLine();
                    System.out.println("client> recieved from server in tails: " + retval);
                    gameView.setGamestatus(retval);
                } catch (IOException ex) {
                    throw new RuntimeException(ex);
                }
